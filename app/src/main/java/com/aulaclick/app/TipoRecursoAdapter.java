...
public class TipoRecursoAdapter extends RecyclerView.Adapter<TipoRecursoAdapter.ViewHolder> {
    ...
    public interface OnTipoClickListener {
        void onEditClick(TipoRecurso tipo);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_tipo_recurso, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> listener.onEditClick(tipo));
